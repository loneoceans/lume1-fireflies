...
// https://budgetlightforum.com/node/73470?page=11
/*
 * For Flashing
 * 8 MHz, 64ms boot delay, enable flashing, disable everything else
 * Use low fuse 0xD2 for 4ms startup delay
 *           or 0xE2 for 64ms, useful on twisty light 
 * Use high fuse 0xDE for BOD 1.8V
 *            or 0xDF for no BOS
 * Recommend low, high as 0xE2 and 0xDE for lume1_E07X
 */
...
#define CONFIGFILE cfg-fireflies-lume1.h
